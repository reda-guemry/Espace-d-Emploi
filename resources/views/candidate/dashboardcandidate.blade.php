                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-red-500 font-medium text-lg">
                                    {{ $candidate->headline ?? 'Senior Software Engineer' }}</p>
                            ...
                            <div class="flex gap-3">
                                <button
                                    class="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-xl font-semibold shadow-lg shadow-red-600/20 transition-all flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button
                                    class="bg-zinc-800 hover:bg-zinc-700 text-white px-6 py-2.5 rounded-xl font-semibold border border-zinc-700 transition-all">
                                    Message
                                </button>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div class="hidden lg:block lg:col-span-3 space-y-6 sticky top-6">
                    ...
                    <div class="bg-zinc-900 rounded-2xl border border-red-900/30 p-6 shadow-lg shadow-red-900/5">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            @foreach (range(1, 9) as $index)
                                <div class="group relative aspect-square">
                                    <div
                                        class="w-full h-full rounded-xl bg-zinc-800 border border-zinc-700 group-hover:border-red-500 transition-all flex items-center justify-center cursor-pointer overflow-hidden">
                                        <span class="text-gray-500 font-bold group-hover:text-white">FR</span>
                                    </div>
                                    @if ($index % 2 == 0)
                                        <span
                                            class="absolute bottom-1 right-1 w-2.5 h-2.5 bg-green-500 border-2 border-zinc-900 rounded-full"></span>
                                    @endif
                                </div>
                            @endforeach
                        </div>
                        ...
                        <button
                            class="w-full mt-6 py-2 bg-zinc-800 hover:bg-zinc-700 text-gray-300 text-sm font-semibold rounded-xl transition-all border border-zinc-700">
                            View Requests (2)
                        </button>
                    </div>
