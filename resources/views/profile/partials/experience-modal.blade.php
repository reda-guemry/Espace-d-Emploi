<div x-show="activeModal === 'experience'" 
    ...
    <div @click.away="activeModal = null"
        ...
        <form action="{{ route('experience.store') }}" method="POST" class="p-6 space-y-5">
            @csrf
            
            <div class="space-y-2">
                <label class="text-xs font-bold text-zinc-400 uppercase tracking-wider">Position</label>
            ...
            <div class="space-y-2">
                <label class="text-xs font-bold text-zinc-400 uppercase tracking-wider">Company Name</label>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-red-900/20">
                ...
                <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-800 hover:from-red-500 hover:to-red-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-red-900/30">Save Experience</button>
            </div>
        </form>
    </div>
</div>