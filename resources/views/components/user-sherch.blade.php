...
<div class="relative w-full mb-6 z-50">
    ...
    <div class="relative group">
        ...
        <input type="text" wire:model.live.debounce.300ms="search"
            class="block w-full pl-11 pr-4 py-3 bg-zinc-900 border border-red-900/30 rounded-2xl leading-5 text-gray-200 placeholder-gray-500 focus:outline-none focus:bg-black focus:border-red-600 focus:ring-1 focus:ring-red-600 sm:text-sm transition-all shadow-lg shadow-red-900/5"
            placeholder="Find people, recruiters, or friends...">
