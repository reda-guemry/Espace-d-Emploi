...
new class extends Component {
    ...
    public function edit($id)
    {
        ...
        $this->pathImage = $vacancieModel->image ;
    ...
    {
        $this->reset(['isEditModalOpen', 'editingId', 'contract_type', 'image', 'finish_at', 'title', 'location', 'description', 'status']);
    }
    ...
    public function update()
    {
        ...
        // dd($this -> title);
        if ($this->image) {
            $this->pathImage = $this->image->store('vacancy', 'public');
        }

        $dto = new VacancieUpdateDTO(
            title: $this->title,
        ...
        app(VacancieService::class)->update(
            $this->editingId,
            $dto
        );
...
<div>
    @if($isEditModalOpen)
        <div class="fixed inset-0 z-[999] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 bg-black/90 backdrop-blur-sm transition-opacity z-40" wire:click="cancelEdit"
                aria-hidden="true">
            </div>
                ...
                <div
                    ...
                    <form wire:submit.prevent="update">
                        <div class="px-6 py-6 space-y-6">
                            ...
                            <div class="space-y-2">
                                <label for="title"
                                    class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Job Title</label>
