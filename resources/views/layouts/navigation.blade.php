            ...
            <div class="flex items-center gap-6">
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div class="w-8 h-8 bg-blue-600 rounded text-white flex items-center justify-center font-bold text-xl">
                            in
                        </div>
                    </a>
                </div>
                ...
                <div class="relative hidden md:block">
                    ...
                    <input type="text" class="bg-slate-100 border-none rounded-md py-2 pl-10 pr-4 text-sm w-64 focus:ring-2 focus:ring-blue-500 placeholder-slate-400 text-slate-600" placeholder="Search...">
                </div>
            </div>

            <div class="hidden md:flex items-center gap-8 text-sm font-medium">
                <a href="{{ route('dashboard') }}" class="h-full flex flex-col justify-center px-1 border-b-2 transition duration-150 ease-in-out {{ request()->routeIs('dashboard') ? 'border-slate-900 text-slate-900' : 'border-transparent text-slate-500 hover:text-slate-700' }}">
                ...
                <a href="#" class="h-full flex flex-col justify-center px-1 border-b-2 border-transparent text-slate-500 hover:text-slate-700 transition">
                    <span class="flex items-center gap-1">
                        ...
                        <x-slot name="trigger">
                            <button class="flex items-center gap-2 focus:outline-none transition ease-in-out duration-150">
                                ...
                                <div class="hidden lg:block text-left">
                                    ...
                                    <div class="text-[10px] text-slate-400">Me ▾</div>
                                </div>
                            </button>
                        </x-slot>
